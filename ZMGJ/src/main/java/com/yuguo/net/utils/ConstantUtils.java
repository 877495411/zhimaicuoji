...
public abstract class ConstantUtils {
	...
	public static final int SELLER_PASSWORD_RESET = 8; // 卖家后台登录密码修改验证码
...
//	public static final String SERVER_URL_SAS_TEST = "http://192.168.0.239:8084/yuguoSAS/"; // 商户管理系统外网地址
    ...
    public static final String NOT_UPLOAD = "2"; // 未上传
    public static final String IS_UPLOAD = "1"; // 已上传

    public static final String AUDIT_NOT_PASS="0";//未通过
    public static final String AUDIT_PASS="1";//审核通过
    public static final String NOT_SUBMIT_AUDIT="2";//未提交审核   默认为2
    public static final String IS_SUBMIT_AUDIT="3";//待审核
}
